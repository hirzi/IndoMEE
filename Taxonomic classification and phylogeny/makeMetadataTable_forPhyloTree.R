...
metadata_df$maaslin_diet <- as.character(metadata_df$original_bin %in% diet_MAGs)
metadata_df$maaslin_pop <- as.character(metadata_df$original_bin %in% pop_MAGs)
...
# Format df
colnames(metadata_df) <- c("original_bin", "genome", "classification", "classification_SNB", "total_abundance", "prevalence", "num_samples", "mean_relative_abundance", "SNB", "phylum", "novelty", "maaslin_diet", "maaslin_pop", "maaslin", "closest_UHGG_ref", "ANI_closest_ref", "n_spore_genes", "PC1_Aitchison", "PC2_Aitchison", "PC1_Jaccard", "PC2_Jaccard")
metadata_df <- metadata_df[, c("original_bin", "genome", "classification", "classification_SNB", "phylum", "closest_UHGG_ref", "ANI_closest_ref", "novelty", "total_abundance", "mean_relative_abundance", "prevalence", "num_samples", "SNB", "maaslin", "maaslin_diet", "maaslin_pop", "n_spore_genes", "PC1_Aitchison", "PC2_Aitchison", "PC1_Jaccard", "PC2_Jaccard")]
...
# Write out table
write.table(metadata_df, paste0("/Users/hl636/Documents/Hirzi/Cambridge/Metagenomics/Phylogenetics/Metadata_", prefix, "_revised20Dec.txt"), row.names = FALSE, quote = FALSE, sep = "\t")
