...
input_bins=/home/hl636/rds/rds-mobile-Gwxt74iudAM/Metagenomics_genomeBasedReference/metaWRAP/OUTPUT/HYBRID_ASSEMBLY/5.4.DREP/allRefinedBins.txt
...
output_dir=/home/hl636/rds/rds-mobile-Gwxt74iudAM/Metagenomics_genomeBasedReference/metaWRAP/OUTPUT/HYBRID_ASSEMBLY/5.4.DREP/Comp50Cont5
mkdir ${output_dir}
...
#CMD="dRep dereplicate ${output_dir} -g ${input_bins} -p $SLURM_CPUS_PER_TASK --S_algorithm fastANI --genomeInfo ${genome_info} -pa 0.9 -sa 0.95 -nc 0.3 -l 50000 -comp 50 -con 5 --multiround_primary_clustering --primary_chunksize 10000 --run_tertiary_clustering --debug" # revised parameters
#dRep dereplicate ${output_dir} -g ${input_bins} -p $SLURM_CPUS_PER_TASK --S_algorithm ANImf --genomeInfo ${genome_info} -pa 0.9 -sa 0.95 -nc 0.3 -l 50000 -comp 70 -con 5 --debug # comp70cont5,final parameters
#dRep dereplicate ${output_dir} -g ${input_bins} -p $SLURM_CPUS_PER_TASK --S_algorithm ANImf --genomeInfo ${genome_info} -pa 0.9 -sa 0.95 -nc 0.3 -l 50000 -comp 50 -con 5 --debug # comp50cont5, final parameters
#dRep dereplicate ${output_dir} -g ${input_bins} -p $SLURM_CPUS_PER_TASK --S_algorithm ANImf --genomeInfo ${genome_info} -pa 0.9 -sa 0.98 -nc 0.3 -l 50000 -comp 50 -con 5 --debug # comp50cont5, final parameters
#dRep dereplicate ${output_dir} -g ${input_bins} -p $SLURM_CPUS_PER_TASK --S_algorithm fastANI --genomeInfo ${genome_info} -pa 0.9 -sa 0.98 -nc 0.3 -l 50000 -comp 50 -con 5 --multiround_primary_clustering --primary_chunksize 10000 --run_tertiary_clustering --debug # comp50cont5, final parameters
dRep dereplicate ${output_dir} -g ${input_bins} -p $SLURM_CPUS_PER_TASK --S_algorithm fastANI --genomeInfo ${genome_info} -pa 0.9 -sa 0.95 -nc 0.3 -l 50000 -comp 50 -con 5 --multiround_primary_clustering --primary_chunksize 10000 --run_tertiary_clustering --debug # comp50cont5, final parameters
#eval $CMD
#echo -e "\nExecuting command:\n==================\n$CMD\n"
