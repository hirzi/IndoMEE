...
bin_refinement_dir="/home/hl636/rds/rds-mobile-Gwxt74iudAM/Metagenomics_genomeBasedReference/metaWRAP/OUTPUT/CO_ASSEMBLY/5.BIN_REFINEMENT"
...
#metawrap bin_refinement -o ${bin_refinement_dir}/${sample_prefix} -t $SLURM_CPUS_PER_TASK -m ${mem_gb} -A ${initial_bins_dir}/${sample_prefix}/metabat2_bins/ -B ${initial_bins_dir}/${sample_prefix}/maxbin2_bins/ -C ${initial_bins_dir}/${sample_prefix}/concoct_bins/ -c 50 -x 5 # individual-assembly + drep post-bin refinement (revised metawrap parameters)
metawrap bin_refinement -o ${bin_refinement_dir}/${pop} -t $SLURM_CPUS_PER_TASK -m ${mem_gb} -A ${initial_bins_dir}/${pop}/metabat2_bins/ -B ${initial_bins_dir}/${pop}/concoct_bins/ -c 50 -x 5 # co-assembly (revised metawrap parameters)
