...
output_dir="/home/hl636/rds/rds-mobile-Gwxt74iudAM/Metagenomics_genomeBasedReference/metaWRAP/OUTPUT/CO_ASSEMBLY/5.2.CHECKM2"
...
echo -e "\nExecuting command:\n==================\n$CMD\n"
CMD="checkm2 predict --threads $SLURM_CPUS_PER_TASK -x .fa --input ${input_dir}/${pop}/metawrap_50_5_bins --output-directory ${output_dir}/${pop}"
eval $CMD
