...
working_dir="/home/hl636/rds/rds-mobile-Gwxt74iudAM/Metagenomics_genomeBasedReference/metaWRAP"
checkm2_dir="/home/hl636/rds/rds-mobile-Gwxt74iudAM/Metagenomics_genomeBasedReference/metaWRAP/OUTPUT/5.2.CHECKM2"
input_bins=/home/hl636/rds/rds-mobile-Gwxt74iudAM/Metagenomics_genomeBasedReference/metaWRAP/OUTPUT/5.4.DREP/allRefinedBins.txt
genome_info=${checkm2_dir}/checkm2_genInfo.csv
#output_dir=/home/hl636/rds/rds-mobile-Gwxt74iudAM/Metagenomics_genomeBasedReference/metaWRAP/OUTPUT/5.4.DREP
output_dir=/home/hl636/rds/rds-mobile-Gwxt74iudAM/Metagenomics_genomeBasedReference/metaWRAP/OUTPUT/5.4.DREP/sANI_98
mkdir ${output_dir}
...
#CMD="dRep dereplicate ${output_dir} -g ${input_bins} -p $SLURM_CPUS_PER_TASK --S_algorithm fastANI --genomeInfo ${genome_info} -pa 0.9 -sa 0.98 -nc 0.3 -l 50000 -comp 50 -con 5 --multiround_primary_clustering --primary_chunksize 10000 --run_tertiary_clustering --debug" # revised parameters
eval $CMD
echo -e "\nExecuting command:\n==================\n$CMD\n"
