...
Rscript /rds/project/rds-Gwxt74iudAM/Metagenomics_genomeBasedReference/metaWRAP/5.7.Filter_dRepGenomes_by_gunc.R
...
rsync -a /home/hl636/rds/rds-mobile-Gwxt74iudAM/Metagenomics_genomeBasedReference/metaWRAP/OUTPUT/5.4.DREP/dereplicated_genomes --files-from=dereplicated_genomes_gunc_finalFiltered_names.txt dereplicated_genomes_gunc_finalFiltered
