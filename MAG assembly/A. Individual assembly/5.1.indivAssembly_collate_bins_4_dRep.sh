...
input_dir="/home/hl636/rds/rds-mobile-Gwxt74iudAM/Metagenomics_genomeBasedReference/metaWRAP/OUTPUT/5.BIN_REFINEMENT"
output_dir="/home/hl636/rds/rds-mobile-Gwxt74iudAM/Metagenomics_genomeBasedReference/metaWRAP/OUTPUT/5.4.DREP"
input_samples="allHumanPilot_excCtrlDogJktMocks_samples.list"
...
for i in $(cat ${working_dir}/${input_samples}); do 
	echo ${i}
