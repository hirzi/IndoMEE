...
output_dir="/home/hl636/rds/rds-mobile-Gwxt74iudAM/Metagenomics_genomeBasedReference/metaWRAP/OUTPUT/5.2.CHECKM2"
...
sample_prefix=`sed -n ${IDX}p < ${samples}`
...
echo -e "\nExecuting command:\n==================\n$CMD\n"
CMD="checkm2 predict --threads $SLURM_CPUS_PER_TASK -x .fa --input ${input_dir}/${sample_prefix}/metawrap_50_5_bins --output-directory ${output_dir}/${sample_prefix}"
eval $CMD
